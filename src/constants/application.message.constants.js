...
export const cencryptStringMessage03 = wrd.cThe + bas.cSpace + wrd.csystem + bas.cSpace + wrd.cadministrator + bas.cSpace + wrd.cwill + bas.cSpace + wrd.chave + bas.cSpace + wrd.ca + bas.cSpace + wrd.cprivate + bas.cSpace + wrd.ckey + bas.cSpace + wrd.cused + bas.cSpace + wrd.cby + bas.cSpace + wrd.cthe + bas.cSpace + wrd.ctesting + bas.cSpace + wrd.cframework + bas.cComa + bas.cSpace + wrd.cto + bas.cSpace + wrd.cbe + bas.cSpace + wrd.ccombined + bas.cSpace + wrd.cwith + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cpublic + bas.cSpace + wrd.ckey + bas.cDot;
// This privateKey should be combined with a publicKey uniquely generated for this specific string encryption.
export const cencryptStringMessage04 = wrd.cThis + bas.cSpace + wrd.cprivate + wrd.cKey + bas.cSpace + wrd.cshould + bas.cSpace + wrd.cbe + bas.cSpace + wrd.ccombined + bas.cSpace + wrd.cwith + bas.cSpace + wrd.ca + bas.cSpace + wrd.cpublic + wrd.cKey + bas.cSpace + wrd.cuniquely + bas.cSpace + wrd.cgenerated + bas.cSpace + wrd.cfor + bas.cSpace + wrd.cthis + bas.cSpace + wrd.cspecific + bas.cSpace + wrd.cstring + bas.cSpace + wrd.cencryption + bas.cDot;
...
export const cencryptStringMessage06 = wrd.calong + bas.cSpace + wrd.cside + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cencrypted + bas.cSpace + wrd.cstring + bas.cDot + bas.cSpace + wrd.cThe + bas.cSpace + wrd.ctesting + bas.cSpace + wrd.cframework + bas.cSpace + wrd.cwill + bas.cSpace + wrd.ctake + bas.cSpace + wrd.cthese + bas.cSpace + wrd.ctwo + bas.cSpace + wrd.cpieces + bas.cSpace + wrd.cof + bas.cSpace + wrd.cdata + bas.cSpace + wrd.cand + bas.cSpace + wrd.ccombine + bas.cSpace + wrd.cit + bas.cSpace + wrd.cwith + bas.cSpace + wrd.cthe;
...
export const cencryptStringMessage13 = wrd.cPlease + bas.cSpace + wrd.center + bas.cSpace + wrd.ca + bas.cSpace + wrd.cprivate + wrd.cKey + bas.cUnderscore + wrd.cpublic + wrd.cKey + bas.cSpace + wrd.cto + bas.cSpace + wrd.cbe + bas.cSpace + wrd.cused + bas.cSpace + wrd.cas + bas.cSpace + wrd.ca + bas.cSpace + wrd.cseed + bas.cSpace + wrd.cfor + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cencryption + bas.cSpace + wrd.cprocess + bas.cDot;
...
export const cencryptStringMessage16 = msg.cERROR_Colon + wrd.cFailure + bas.cSpace + wrd.cto + bas.cSpace + wrd.cencrypt + bas.cSpace + wrd.cstring + bas.cDot + bas.cSpace + wrd.cPlease + bas.cSpace + wrd.cfile + bas.cSpace + wrd.ca + bas.cSpace + wrd.csupport + bas.cSpace + wrd.cticket + bas.cSpace + wrd.cwith + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cHay + bas.cDash + wrd.cCAF + bas.cSpace + wrd.crepo + bas.cComa;
// or contact Haystacks Tech support team, repo link and contact details are provided in the Hay-CAF product documentation.
export const cencryptStringMessage17 = wrd.cor + bas.cSpace + wrd.ccontact + bas.cSpace + wrd.cHaystacks + bas.cSpace + wrd.cTech + bas.cSpace + wrd.csupport + bas.cSpace + wrd.cteam + bas.cComa + bas.cSpace + wrd.crepo + bas.cSpace + wrd.clink + bas.cSpace + wrd.cand + bas.cSpace + wrd.ccontact + bas.cSpace + wrd.cdetails + bas.cSpace + wrd.care + bas.cSpace + wrd.cprovided + bas.cSpace + wrd.cin + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cHay + bas.cDash + wrd.cCAF + bas.cSpace + wrd.cproduct + bas.cSpace + wrd.cdocumentation + bas.cDot;
...
export const cdecryptStringMessage08 = msg.cERROR_Colon + wrd.cFailure + bas.cSpace + wrd.cto + bas.cSpace + wrd.cdecrypt + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cstring + bas.cDot + bas.cSpace + wrd.cPlease + bas.cSpace + wrd.cfile + bas.cSpace + wrd.ca + bas.cSpace + wrd.csupport + bas.cSpace + wrd.cticket + bas.cSpace + wrd.cwith + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cHay + bas.cDash + wrd.cCAF + bas.cSpace + wrd.crepo + bas.cComa;
