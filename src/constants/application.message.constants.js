...
export const cforwardCompatibilityModeIs = wrd.cforward + wrd.cCompatibility + wrd.cMode + sys.cSpaceIsColonSpace; // forwardCompatibilityMode is:
...
export const cSuccessSetForwardCompatibilityModeConfigurationMessage = msg.cSUCCESS_Colon + app_cfg.cforwardCompatibilityMode + cconfigurationSettingSuccessfullyChanged; // SUCCESS: forwardCompatibilityMode configuration setting successfully changed.
